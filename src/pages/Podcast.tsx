...
import { Mic, Rocket, Bot, Target, Users, Play } from "lucide-react";
...
const pillars = [
  ...
  { icon: Target, title: "The Value Your Company Provides", desc: "What sets your offering apart and the impact it creates." },
  { icon: Users, title: "Business Goals and Challenges", desc: "Where you're heading and the barriers in the way." },
